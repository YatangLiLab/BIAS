...
if __name__ == '__main__':
    ...
    parser.add_argument('--resume_model_path', type=str, default=r'E:\YourPath(some logs are changed after generated only for anonymity)\MS-TCA\MyMSTCN\model\bestSal2\2025-08-18-21-26-32\best_model.pth')
