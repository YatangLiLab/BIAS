...
============================================================
test_pred/itti/SM_predictions.jsonl: Average Advance Time = -0.2796 (samples: 279)
test_pred/salfom/SM_predictions.jsonl: Average Advance Time = -0.0982 (samples: 279)
test_pred/DSTA_label/SM_predictions.jsonl: Average Advance Time = 3.8459 (samples: 279)
test_pred/ustring_label/SM_predictions.jsonl: Average Advance Time = 4.9885 (samples: 279)
test_pred/DRIVE_label/SM_predictions.jsonl: Average Advance Time = 6.6774 (samples: 279)
test_pred/RGB_predictions.jsonl: Average Advance Time = 0.0822 (samples: 279)
test_pred/SM_predictions.jsonl: Average Advance Time = 0.7176 (samples: 279)
'''
...
for method, result in avg_advance_time_results.items():
    ...
    print(f"{method}: Average Advance Time = {result['avg_advance_time']:.4f} (samples: {result['count']})")
