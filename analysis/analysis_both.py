...
def multi_hist(todo_key=None,metric_=None):
    ...
    metric_set = ['Diff_1-1','Diff_1-2','Diff_1-3','Diff_1-4','Diff_1-5','Diff_1-6']# ['1-1cc','1-2cc','1-3cc','1-4cc','1-5cc','1-6cc','GTPeaks','1-4peaknum'] # ['cc', 'sim', 'nss', 'auc_judd', 'kldiv', 'aucs']
...
def main():
    ...
    metrics_ = ['Diff_1-1','Diff_1-2','Diff_1-3','Diff_1-4','Diff_1-5','Diff_1-6']# ['1-1cc','1-2cc','1-3cc','1-4cc','1-5cc','1-6cc','GTPeaks','1-4peaknum']
    for key in keys:
