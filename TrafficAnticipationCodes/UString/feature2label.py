...
if __name__ == '__main__':
    ...
    # inference
    parser.add_argument('--label_folder', type=str, help="the path to the feature file.", default="./ustring_label")
    parser.add_argument('--ckpt_file', type=str, help="the path to the model file.", default="models/UString/final_model_crash_vgg16.pth")
    # visualize
    ...
    for feature_path in tqdm.tqdm(feature_paths):
        ...
        features, labels, graph_edges, edge_weights, toa, detections, vid = load_input_data(os.path.join(feature_folder, feature_path), device=device)
        ...
        pred_score, pred_au, pred_eu = parse_results(all_outputs, n_frames=true_frames)
        print((pred_score.shape), (pred_au.shape), (pred_eu.shape))
        print('%#$#$% ==================== %#$#$%')
