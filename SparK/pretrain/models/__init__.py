...
from models.resnet18 import SaliencyMapConvNet
from models.resnet18_inference import SaliencyMapConvNet_INF
_import_resnets_for_timm_registration = (ResNet, SaliencyMapConvNet, SaliencyMapConvNet_INF)
