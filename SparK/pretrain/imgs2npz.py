...
sm_img_root = '/mnt/e/Li Lab/MS-TCA/MyMSTCN/data/Salfomdataset/val'
...
dense_encoder.load_state_dict(torch.load(os.path.join('ResNet18-salfom','SaliencyMap_1kpretrained_timm_style.pth'))) # load corresponding
# dense_encoder.to_dense()
# convert_sparse_bn_to_regular_bn(dense_encoder)
dense_encoder.eval()
dense_encoder = dense_encoder.cuda()

tgt_npz_folder = '/mnt/e/Li Lab/MS-TCA/MyMSTCN/data/Salfomdataset/Salfomfeature_npy'
