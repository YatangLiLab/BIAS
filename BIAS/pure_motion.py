...
def parse_args():
    ...
    parse.add_argument('--video_path', default="E:\\Li Lab\\itti_and_lif\\RealtimeSaliency\\test_video\\motion_sample_video.mp4", type=str, help='path of sample video') 
    parse.add_argument('--generate_name',default = "result_video\\pure_motion_sample_video.mp4",type=str,help = 'default generate name')
